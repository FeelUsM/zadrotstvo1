...
'argv'=<?php echo $_SERVER['argv']?> 
<hr>
<p title="Директория корня документов, в которой выполняется текущий скрипт, в точности та, которая указана в конфигурационном файле сервера.">'DOCUMENT_ROOT'=<?php echo $_SERVER['DOCUMENT_ROOT']?> 
...
'PATH_TRANSLATED'=<?php echo $_SERVER['PATH_TRANSLATED']?> 
<hr>
...
'SERVER_SOFTWARE'=<?php echo $_SERVER['SERVER_SOFTWARE']?> 
...
'SERVER_SIGNATURE'=<?php echo $_SERVER['SERVER_SIGNATURE']?> 
...
'SERVER_ADMIN'=<?php echo $_SERVER['SERVER_ADMIN']?> 
<p>.
...
'SERVER_PROTOCOL'=<?php echo $_SERVER['SERVER_PROTOCOL']?> 
...
'SERVER_PORT'=<?php echo $_SERVER['SERVER_PORT']?> 
<hr>
...
'PATH_INFO'=<?php echo $_SERVER['PATH_INFO']?> 
<p title="Исходное значение переменной 'PATH_INFO' до начала обработки PHP.">
'ORIG_PATH_INFO'=<?php echo $_SERVER['ORIG_PATH_INFO']?> 
...
'PHP_AUTH_DIGEST'=<?php echo $_SERVER['PHP_AUTH_DIGEST']?> 	
